...
<html>
<head>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/layui/2.5.5/css/layui.css" />
        ...
        <div class='layui-side-scroll  layui-bg-blue'>
            <ul class='layui-nav layui-bg-blue layui-nav-tree' lay-filter='side'>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            &nbsp;&nbsp;&nbsp;&nbsp;<a data-url="${pageContext.request.contextPath}/admin/ToUserList" data-id="userlist" data-title="人员查看" class="site-demo-active"  href="javascript:;" data-type="tabAdd"><i class="layui-icon layui-icon-rate-half"></i>&nbsp;&nbsp;人员查看</a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
